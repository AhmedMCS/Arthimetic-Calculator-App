...
button9 = Button(frame, text=9, height=4, width=6, font=35, 
                 command = lambda: press
                (9))
...
multiply = Button(frame, text='*', height=4, width=6, font=35, 
                 command = lambda: press
                ('*'))
multiply.grid(row=2, column=3)

divide = Button(frame, text='/', height=4, width=6, font=35, 
                 command = lambda: press
                ('/'))
...
clear = Button(window, text='clear', height=4, width=27, font=35, 
                 command = clear)
clear.pack()
window.mainloop()